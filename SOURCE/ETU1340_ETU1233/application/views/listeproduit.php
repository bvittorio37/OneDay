	...
	<?php foreach($rowsProduit as $tableau){ ?>
		<div class="card " style="width: 18rem;margin-left:10px;margin-top:10px;background-image:url(png/fond1.png)">
		  ...
		  <div class="card-body">
			...
			<a href="http://localhost/ETU1340_ETU1233/produit/redirectionModif/saisieModif.php/<?php echo $tableau['idProduits'];?> "><input type="button" value="Modifier" class="btn btn-primary"></a></p>
			<a href="http://localhost/ETU1340_ETU1233/produit/deleteproduit/<?php echo $tableau['idProduits'];?>/listeproduit.php"><input type="button" value="Supprimer" class="btn btn-primary"></a></p>
